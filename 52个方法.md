...
```
id maybeAnAray = /*...*/
if([maybeAnArray isKindOfClass:[NSArray calss]])}
    //do
```
...
##### 11.理解 $objc \underline{} msgSend$ 的作用
...
```
上述结构体用来存放类的“元数据” ，$Class$ 对象本身也是一个 $OC$ 对象，结构体内的 “$super_class$” 定义了本类的超类。类对象所属的类型，由“$isa$”指针指向另一个类 叫做“元类” ，“$super \underline{} class$” 指向                                                                                                                                               